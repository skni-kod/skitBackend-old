    ...
    public partial class InitialDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompaniesTechnologies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompaniesTechnologies_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompaniesTechnologies_Technologies_TechnologyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompaniesTechnologies_CompanyId",
                table: "CompaniesTechnologies",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CompaniesTechnologies_TechnologyId",
                table: "CompaniesTechnologies",
                column: "TechnologyId");
        }
